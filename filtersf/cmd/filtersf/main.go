...
func Usage() {
	fmt.Fprintf(os.Stderr, "Usage of filtersf:\n")
	fmt.Fprintf(os.Stderr, "\tfiltersf [flags] -type T [directory]\n")
	fmt.Fprintf(os.Stderr, "\tfiltersf [flags] -type T files... # Must be a single package\n")
...
func main() {
	...
	g := Generator{}
	g.Printf("// Code generated by \"filtersf %s\"; DO NOT EDIT.\n", strings.Join(os.Args[1:], " "))
	g.Printf("\n")
	g.Printf("package filtersf")
	g.Printf("\n")
